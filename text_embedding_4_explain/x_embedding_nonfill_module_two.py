...
for g1, g2 in group_pairs:
    cleaned_g1 = clean_name(g1)
    cleaned_g2 = clean_name(g2)

    file_name = f"text_embeddings_{cleaned_g1}_{cleaned_g2}.npy"
    file_name_r = f"text_embeddings_{cleaned_g2}_{cleaned_g1}.npy"
    ...
    print(f"Processing {g1} ({len(feats1)}) + {g2} ({len(feats2)}) ----------")
