...
# %%
df_plasma_human_Au = df_plasma_human[df_plasma_human['Core']=='Au']
df_plasma_human_Au

# %%
df_plasma_human_Au['DOI'].unique()
...
# %%
df_nano_external_plasma_human = df_plasma_human.loc[df_plasma_human_Au.index,:]
...
# %%
mask_core_not_au = df['Core'].ne('Au')   # 等价于 df['Core'] != 'Au'
df = df[mask_core_not_au]
df
