...
for col in feature_columns:
    ...
    x_embed_data_non_fill = np.load(f"../text_embedding_4_explain/nonfill/text_embeddings_{cleaned_col}.npy") 
...
# %%
result_df.to_csv('tabular_feature_binary_single.csv', index=False)
