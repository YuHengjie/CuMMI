...
# %%
f1_result_df = pd.DataFrame(index=group_names, columns=group_names)
f1_result_df

# %%
for col1, col2 in group_pairs:
    ...
    x_embed_data_non_fill = np.load(f"../text_embedding_4_explain/nonfill_module_two/text_embeddings_{cleaned_col1}_{cleaned_col2}.npy")
...
# %%
f1_result_df.to_csv('tabular_module_two.csv',)
