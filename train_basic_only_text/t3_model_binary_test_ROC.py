...
roc_npy_path = os.path.join(work_dir, f"roc_internal_stage_{load_stage}.npy")
...
pr_npy_path = os.path.join(work_dir, f"pr_internal_stage_{load_stage}.npy")
...
roc_png_path = os.path.join(work_dir, f"roc_internal_stage_{load_stage}.png")
...
pr_png_path = os.path.join(work_dir, f"pr_internal_stage_{load_stage}.png")
