...
# %%
mean_value = np.mean(stats_external_modal)
mean_value
...
ax.plot(angles, stats_baseline_modal, marker='s', markersize=4,
        color='#BABABA', linewidth=1, linestyle='solid', label='Baseline: 0.7')
...
plt.tight_layout()
plt.savefig('radar_modal compare_external_date.png', dpi=600)  # dpi 参数控制图片分辨率
...
# %%
# %%
train_external_json = '../train_nano/output/stage_12345/eval_results.json'
...
plt.tight_layout()
plt.savefig('radar_modal compare_external_nano.png', dpi=600)  # dpi 参数控制图片分辨率
#plt.savefig('modal compare-binary.svg', )  # dpi 参数控制图片分辨率
...
# %%
# %%
train_external_json = '../train_protein/output/stage_12345/eval_results.json'
...
plt.tight_layout()
plt.savefig('radar_modal compare_external_protein.png', dpi=600)  # dpi 参数控制图片分辨率
#plt.savefig('modal compare-binary.svg', )  # dpi 参数控制图片分辨率
